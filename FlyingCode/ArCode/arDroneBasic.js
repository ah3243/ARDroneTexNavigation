    ...
    function opencvScript(exec, imagePath, droneState, client, callback){
      ...
      exec('sh ~/Desktop/MyFilterbankCode/OpenCvPrograms/FlyingCode/OpencvCode/9_Testing.sh ' + imagePath, function(error, stdout, stderr){
        if(error += null){
    ...
    function startProgram(exec, pngBuffer, droneState, client){
      ...
      var imageDir = '~/Desktop/MyFilterbankCode/OpenCvPrograms/FlyingCode/CollectedImgs/'; // Image FolderPath partial
      var imageName = imageDir + 'frame' + droneState.imgFrameNum + '.png';
      // Write file to dir
